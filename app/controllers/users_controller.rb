    ...
    respond_to do |format|
      if @user.update(user_password_params)
        ...
        format.html {
          ...
          notice: 'Password was succesfully updated.'
        }
      else
    ...
    respond_to do |format|
      if @user.update(user_params)
        format.html {
          ...
          notice: 'Your information was succesfully updated.'
        }
      else
      ...
      begin
        if @user.valid? && @user.invite!(current_user)
          ...
          format.html {
            ...
            notice: 'User was succesfully invited.'
          }
        else
  ...
  def update
    respond_to do |format|
      if @user.update(user_params.except('role'))
        format.html {
          redirect_to account_users_path,
          notice: 'User was succesfully updated.'
        }
      else
        format.html { render :edit }
      end
